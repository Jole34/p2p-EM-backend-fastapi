...
def buy_energy(user: User = Depends(verify_token), energy_amount: float = None, money_amount: float = None):
    ...
    if energy_amount:   
        ...
        trade = models.Trade(
            ...
            moment_balance=energy_amount*result_constant,
        ...
        trade = models.Trade(
            ...
            moment_balance=int((money_amount/result_constant)*100)/100,
            trade_id=str(uuid.uuid1()),
            currency='USD',
            user_id=user.id
        )
...
def sell_energy(user: User = Depends(verify_token), energy_amount: schemas.Energy = None):
    ...
    trade = models.Trade(
            ...
            price=1/result_constant,
            moment_balance=energy_amount.energy_amount*result_constant,
            trade_id=str(uuid.uuid1()),
            currency='USD',
            user_id=user.id
        )
