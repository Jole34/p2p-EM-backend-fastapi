...
class User(Base):
    ...
    role_id_1 = Column(Integer, ForeignKey(Role.id), nullable=True)
    role__1 = relationship(Role, foreign_keys=[role_id_1], uselist=False)
    role_id_2 = Column(Integer, ForeignKey(Role.id),  nullable=True)
    role__2 = relationship(Role, foreign_keys=[role_id_2], uselist=False)
    role_id_3 = Column(Integer, ForeignKey(Role.id),  nullable=True)
